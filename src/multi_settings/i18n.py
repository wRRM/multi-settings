...
_SWEDISH: dict[str, str] = {
    ...
    "Settings are loaded from the package and then ~/.config/multi-settings/custom-settings.yaml. Your settings take precedence.": "Inställningar läses från paketet och därefter från ~/.config/multi-settings/custom-settings.yaml. Dina inställningar har företräde.",
    ...
    "Imported custom settings. They will override package and role defaults.": "Anpassade inställningar importerades. De åsidosätter paketets och rollernas standardvärden.",
    "Auditing…": "Granskar…",
