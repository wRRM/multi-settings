...
_SWEDISH: dict[str, str] = {
    ...
    "Settings are automatically loaded from ~/.config/multi-settings/custom-settings.yaml before every audit or apply operation.": "Inställningar läses automatiskt från ~/.config/multi-settings/custom-settings.yaml före varje granskning eller tillämpning.",
    ...
    "You cannot remove the account currently running Multi Settings.": "Du kan inte ta bort kontot som kör Multi Settings.",
